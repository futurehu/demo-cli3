<template>
  <cascadePicker ref="cascadePicker" :title="title" :data="data" :selectedIndex="selectedIndex" @select="select" @cancel="cancel">
  </cascadePicker>
</template>

<script>
  import cascadePicker from "./multiple-picker.vue";
